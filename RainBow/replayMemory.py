...
class ReplayMemory:
    ...
    def sample(self, batch_size, indexes=None):
        ...
        zipped[0] = np.reshape(zipped[0], (-1, self.payload_size))
        zipped[3] = np.reshape(zipped[3], (-1, self.payload_size))
        return zipped
...
class PriorityExperienceReplay:
    ...
    def sample(self, batch_size, indexes=None):
        ...
        zipped[0] = np.reshape(zipped[0], (-1, payload_size))
        zipped[3] = np.reshape(zipped[3], (-1, payload_size))
